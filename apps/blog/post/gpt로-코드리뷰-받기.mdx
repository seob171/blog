...
<br/>
<img src={'/assets/gpt-월간-사용량.png'} width={'580px'} height={'auto'} alt={'gpt 사용량 확인 이미지'} className="mx-auto"/>

사용량 확인은 [여기](https://platform.openai.com/organization/usage)서 하면 되고, 결제수단을 등록한다면 빌링을 설정해서 과금이 발생하지 않도록 주의하자.

### 4. 코드리뷰 후기

<img src={'/assets/코드리뷰.png'} width={'580px'} height={'auto'} alt={'Pull Request 코드리뷰 이미지'} className="mx-auto"/>
<br/>
